  ...
  const handleEmailInput = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (target.value === "") {
      ...
      target.setCustomValidity(
        `Por favor, inclua um '@' no endereço de e-mail. '${target.value}' está faltando um '@'.`,
      );
        ...
        <div className="flex w-full flex-col justify-center bg-[#FEFFFF] p-8 md:w-1/2 overflow-y-auto max-h-[90vh] md:max-h-none">
          <div className="mx-auto w-full max-w-md space-y-5">
            <div className="text-center md:text-left">
              <h2 className="text-2xl font-bold text-[#2B7A78]">
                Crie sua conta
              </h2>
              <p className="mt-1 text-xs text-[#718096]">
                Preencha os dados obrigatórios e opcionais
              </p>
            </div>
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      onInvalid={(e) =>
                        handleInvalidMessage(e, "Por favor, insira o seu CPF.")
                      }
                      onInput={handleInputClearValidity}
                      value={cpf}
                ...
                <div className="space-y-1">
                  <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        onInvalid={(e) =>
                          handleInvalidMessage(e, "Crie uma senha de acesso.")
                        }
                        onInput={handleInputClearValidity}
                        value={senha}
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        onInvalid={(e) =>
                          handleInvalidMessage(e, "Confirme a sua senha.")
                        }
                        onInput={handleInputClearValidity}
                  ...
                  {senha.length > 0 && Array.from(senha).length < 8 && (
                    <p className="text-[11px] text-red-500 font-medium pl-1 transition-all">
                      * A senha deve conter no mínimo 8 caracteres. (Digitado:{" "}
                      {Array.from(senha).length})
                    </p>
                  )}
                </div>
              </div>
